  ...
  children: [
    {
      title: '核心框架',
      children: [
        { title: 'Vue3', uri: 'https://cn.vuejs.org/' },
        { title: 'NestJS', uri: 'https://nestjs.com/' },
        { title: 'Prisma', uri: 'https://www.prisma.io/' },
    ...
    },
    {
      title: '周边生态',
      children: [
        { title: 'Vue Router', uri: 'https://router.vuejs.org/zh/' },
        { title: 'Pinia', uri: 'https://pinia.vuejs.org/zh/' },
        { title: 'Vue I18n', uri: 'https://vue-i18n.intlify.dev/' },
        { title: 'VueUse', uri: 'https://vueuse.org/' },
        { title: 'Vuex', uri: 'https://next.vuex.vuejs.org/zh/index.html' },
        { title: 'React Router', uri: 'https://reactrouter.com/en/main' },
        { title: 'React Redux', uri: 'https://cn.react-redux.js.org/' },
        { title: 'ahooks', uri: 'https://ahooks.js.org/zh-CN' },
        { title: 'react-use', uri: 'https://github.com/zenghongtu/react-use-chinese' },
        { title: 'Vitest', uri: 'https://cn.vitest.dev/' },
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          title: '语言',
          children: [
            { title: 'Sass', uri: 'https://www.sass.hk/docs/' },
            { title: 'less 中文网', uri: 'https://less.bootcss.com/' },
            { title: 'Stylus 中文网', uri: 'https://www.stylus-lang.cn/' },
            { title: 'TypeScript', uri: 'https://www.typescriptlang.org/' },
            { title: 'TypeScript 中文网', uri: 'https://ts.nodejs.cn/' },
            { title: 'Node.js 中文网', uri: 'https://nodejs.cn/' },
            { title: 'MDN', uri: 'https://developer.mozilla.org/zh-CN/' },
            { title: 'ES6 入门教程', uri: 'https://es6.ruanyifeng.com/' }
          ]
        },
        {
          title: '包管理工具',
          children: [
            { title: 'npm', uri: 'https://www.npmjs.com/' },
            { title: 'Yarn', uri: 'https://yarnpkg.com/' },
            { title: 'pnpm', uri: 'https://pnpm.io/zh/motivation' }
          ]
        },
        {
          title: '工程化工具',
          children: [
            ...
            { title: 'Vite中文网', uri: 'https://cn.vitejs.dev/' },
            { title: 'esbuild(en)', uri: 'https://esbuild.github.io/' },
            { title: 'Rollup', uri: 'https://cn.rollupjs.org/' },
        ...
        },
        {
          title: 'CSS 类库',
          children: [
            { title: 'Windi CSS', uri: 'https://windicss.org/' },
            { title: 'Tailwind CSS', uri: 'https://tailwindcss.com/' }
          ]
        },
        { title: 'Patterns 设计模式', uri: 'https://www.patterns.dev/' },
        { title: 'Puppeteer', uri: 'https://pptr.dev/' },
        { title: 'Lodash', uri: 'https://lodash.com/' }
      ]
    },
    {
      title: '跨端框架',
    ...
    },
    {
      ...
      children: [
        ...
        { title: 'Google 翻译', uri: 'https://translate.google.com/' },
        { title: 'iconfont', uri: 'https://www.iconfont.cn/' },
        { title: 'Gravatar', uri: 'https://cn.gravatar.com/' },
        { title: 'Cravatar', uri: 'https://cravatar.cn/' },
        { title: 'The Cat API', uri: 'https://thecatapi.com/' },
        { title: 'The Dog API', uri: 'https://thedogapi.com/' },
        { title: '在线工具大全', uri: 'https://www.lddgo.net/index' },
        { title: 'Stack Overflow', uri: 'https://stackoverflow.com/' },
        { title: 'TypeScript PlayGround', uri: 'https://www.typescriptlang.org/play' }
      ]
    },
    {
      title: '博文精选',
      children: [
        {
          ...
          children: [
            ...
            { title: '高频前端面试题汇总之HTML篇', uri: 'https://juejin.cn/post/6905294475539513352' }
          ]
        },
        {
          title: '知识体系',
        ...
        },
        {
          title: 'TypeScript',
          children: [
            { title: '重学 TS - 掘金', uri: 'https://juejin.cn/post/7211358106629750841' },
            { title: 'type challenges', uri: 'https://github.com/type-challenges/type-challenges/blob/main/README.zh-CN.md' },
            { title: 'TypeScript 高级教程1 – 把 TypeScript 当强类型语言使用', uri: 'https://www.cnblogs.com/keatkeat/p/16817229.html' },
            { title: 'TypeScript 高级教程2 – 把 TypeScript 当编程语言使用', uri: 'https://www.cnblogs.com/keatkeat/p/16830664.html' },
            { title: 'TypeScript 高级教程3 – TypeScript 类型体操', uri: 'https://www.cnblogs.com/keatkeat/p/16905910.html' },
            { title: '深入理解 TypeScript', uri: 'https://jkchao.github.io/typescript-book-chinese/#why' }
          ]
        },
        ...
        { title: '从这 25 个方面优化你的前端项目', uri: 'https://cloud.tencent.com/developer/article/1473458' }
      ]
    }
  ]
}
